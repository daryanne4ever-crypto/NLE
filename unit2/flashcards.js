...
g.addEventListener('click',e=>{const card=e.target.closest('.flash-card');if(!card)return;card.querySelector('.hidden-info').style.display='block';addUnitXP('unit2',1,'Unit1 Flashcard');});
